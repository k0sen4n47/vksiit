...
class TeacherController extends Controller
{
    ...
    public function storeTeacher(Request $request)
    {
        ...
        $lastName = StudentController::transliterateCyrillicToLatin(array_shift($fioParts));
        $firstNameInitial = !empty($fioParts) ? StudentController::transliterateCyrillicToLatin(mb_substr(array_shift($fioParts), 0, 1, 'UTF-8')) : '';
