...
class RegisterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Используем transliterateCyrillicToLatin, предполагая, что этот метод доступен (скопируем его сюда из StudentController)
        $shortNamePart = StudentController::transliterateCyrillicToLatin($group->short_name);
